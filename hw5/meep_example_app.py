...
class MeepExampleApp(object):
    ...
    def __init__(self):
        meeplib._threads, meeplib._user_ids, meeplib._users = meeplib.load()
    ...
    def index(self, environ, start_response):
        ...
        print "User = %s" % user
        if user is None:
			s =  ["""<h1>Welcome <i style = "color:red;">Human</i>!</h1><h2>Please Login or create an account.</h2>
...
<p>Don't have an account? Create a user <a href='/create_user'>here</a>"""]
            ...
            s =  ["""%s logged in!<p><a href='/m/add_message'>Add a Message</a><p><a href='/create_user'>Create a User</a><p><a href='/logout'>Log out</a><p><a href='/m/list'>Show All Messages</a>""" % (username,)]
        return s
